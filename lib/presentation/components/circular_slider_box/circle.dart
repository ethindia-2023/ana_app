...
class Circle extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    canvas.drawCircle(center, radius - 10, unSelectedAreaBrush);
    canvas.drawArc(
        Rect.fromCircle(center: const Offset(0, 0), radius: radius - 14),
        0, //radians
        -angle * pi / 180, //radians
        false,
        sliderBrush);
    canvas.drawCircle(center, radius - 18, circleBrush);
  }
